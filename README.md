...
Develop a demonstration application to display a variable-color floating smoke model using Adreno GPU SDK.
...
===>fluid.cpp:   Floating smoke source code cpp file(If you do not define GRADIENT_COLOR,that will be Floating smoke1.0).
...
1、Download code from github according to the repository from　“https://github.com/ThunderSoft-XA/FloatingSmoke2.0.git”.
